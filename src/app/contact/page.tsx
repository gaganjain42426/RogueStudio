      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-8">
        ...
        <div className="mt-40 bg-surface text-on-surface py-20 rounded-xl px-6 md:px-12">
          ...
          <div className="w-full h-[400px] md:h-[500px] rounded-lg overflow-hidden border border-outline-variant/20 grayscale hover:grayscale-0 transition-all duration-700">
            <iframe
              title="Rogue Studio location — Jaipur"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3559.6!2d75.8022!3d26.8574!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjbCsDUxJzI2LjYiTiA3NcKwNDgnMDcuOSJF!5e0!3m2!1sen!2sin!4v1234567890"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              loading="lazy"
