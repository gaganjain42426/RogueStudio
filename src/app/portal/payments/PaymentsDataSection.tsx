...
/**
 * Async Server Component — fetches payments for the given client and renders
 * the summary cards + table. Wrapped in <Suspense> in the parent page so the
 * "Payments" heading renders immediately.
 *
 * Optimisations: specific columns, .limit(100), client_id filter.
 * 100 rows = 8+ years of monthly retainer invoices — safe upper bound.
 */
export default async function PaymentsDataSection({ clientId }: { clientId: string }) {
