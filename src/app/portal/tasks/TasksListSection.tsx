...
/**
 * Async Server Component — fetches tasks for the given client and renders
 * them grouped by status. Wrapped in <Suspense> in the parent page so the
 * page header (title + request button) renders immediately.
 *
 * Optimisations: specific column list, .limit(50), client_id filter.
 */
export default async function TasksListSection({ clientId }: { clientId: string }) {
